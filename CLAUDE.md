...
│                                    ▼                                         │
│                    ┌───────────────────────────────┐                        │
│                    │ Enrich & Evaluate Pipeline v9.10  │◄── UPDATE_AFTER_IMPORT
...
│                                    ▼                                         │
│                    ┌───────────────────────────────┐                        │
│                    │  Job Evaluation Pipeline v6.7   │◄── v24qHkIsp8GVCwFkscHP8
...
**Job evaluation:**
All job workflows use the shared `Job Evaluation Pipeline v6.7.json` subworkflow:
...
| Enrich & Evaluate Pipeline v9.10 | **ACTIVE** | v9.10: Merger/rebrand detection (pe-merger-detection-v1.1) |
| Job Evaluation Pipeline v6.7 | **ACTIVE** | v6.7: Merger/rebrand detection (pe-merger-detection-v1.1) |
